...
namespace Persistence.Migrations
{
    ...
    [Migration("20260419015122_Upgrade_DB_V10")]
    partial class Upgrade_DB_V10
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.T_USER_TRAINING_ENROLLMENT", b =>
                {
                    ...
                    b.Property<int>("T_TrainingParticipantId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("T_TrainingParticipantId");
            ...
            modelBuilder.Entity("Domain.Entities.T_USER_TRAINING_ENROLLMENT", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.T_TRAINING_PARTICIPANT", "T_TrainingParticipant")
                        .WithMany()
                        .HasForeignKey("T_TrainingParticipantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
