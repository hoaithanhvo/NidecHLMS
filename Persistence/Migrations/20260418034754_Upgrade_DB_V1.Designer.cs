...
namespace Persistence.Migrations
{
    ...
    [Migration("20260418034754_Upgrade_DB_V1")]
    partial class Upgrade_DB_V1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.T_USER_TRAINING_PROGRESS", b =>
                {
                    ...
                    b.Property<int?>("M_TRAINING_CONTENT_FLOW_STEPId")
                        .HasColumnType("int");

                    b.Property<int?>("M_TRAINING_CONTENT_STEPId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("T_TRAINING_ATTENDEEId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("M_TRAINING_CONTENT_FLOW_STEPId");

                    b.HasIndex("M_TRAINING_CONTENT_STEPId");
                    ...
                    b.HasIndex("T_TRAINING_ATTENDEEId");
            ...
            modelBuilder.Entity("Domain.Entities.T_USER_TRAINING_PROGRESS", b =>
                {
                    b.HasOne("Domain.Entities.M_TRAINING_CONTENT", null)
                        .WithMany("T_UserTrainingProcess")
                        .HasForeignKey("M_TRAINING_CONTENTId");

                    b.HasOne("Domain.Entities.M_TRAINING_CONTENT_FLOW_STEP", null)
                        .WithMany("T_UserTrainingProcess")
                        .HasForeignKey("M_TRAINING_CONTENT_FLOW_STEPId");

                    b.HasOne("Domain.Entities.M_TRAINING_CONTENT_STEP", null)
                        .WithMany("T_UserTrainingProcess")
                        .HasForeignKey("M_TRAINING_CONTENT_STEPId");
                    ...
                    b.HasOne("Domain.Entities.T_TRAINING_ATTENDEE", null)
                        .WithMany("T_UserTrainingProgress")
                        .HasForeignKey("T_TRAINING_ATTENDEEId");
