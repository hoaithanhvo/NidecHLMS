...
{
    /// <inheritdoc />
    public partial class Upgrade_DB_V20 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "M_TRAINING_CONTENT_STEP_TRANSITION",
                columns: table => new
                {
                    ...
                    ConditionType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_M_TRAINING_CONTENT_STEP_TRANSITION", x => x.Id);
                    table.ForeignKey(
                        name: "FK_M_TRAINING_CONTENT_STEP_TRANSITION_M_TRAINING_CONTENT_FLOW_TrainingContentFlowId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_M_TRAINING_CONTENT_STEP_TRANSITION_FromStepId_ActionCode_ToStepId",
                table: "M_TRAINING_CONTENT_STEP_TRANSITION",
                columns: new[] { "FromStepId", "ActionCode", "ToStepId" },
                unique: true,
                filter: "[TrainingContentFlowId] IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_M_TRAINING_CONTENT_STEP_TRANSITION_FromStepId_ActionCode_ToStepId_TrainingContentFlowId",
                table: "M_TRAINING_CONTENT_STEP_TRANSITION",
                columns: new[] { "FromStepId", "ActionCode", "ToStepId", "TrainingContentFlowId" },
                unique: true,
                filter: "[TrainingContentFlowId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_M_TRAINING_CONTENT_STEP_TRANSITION_ToStepId",
                table: "M_TRAINING_CONTENT_STEP_TRANSITION",
                column: "ToStepId");

            migrationBuilder.CreateIndex(
                name: "IX_M_TRAINING_CONTENT_STEP_TRANSITION_TrainingContentFlowId",
                table: "M_TRAINING_CONTENT_STEP_TRANSITION",
                column: "TrainingContentFlowId");

            migrationBuilder.CreateIndex(
                name: "IX_Transition_FromStep_Action_Flow",
                table: "M_TRAINING_CONTENT_STEP_TRANSITION",
                columns: new[] { "FromStepId", "ActionCode", "TrainingContentFlowId" });
