...
namespace Persistence.Migrations
{
    ...
    [Migration("20260426043556_Upgrade_DB_V36")]
    partial class Upgrade_DB_V36
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.M_REQUIREMENT_TYPE", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("M_REQUIREMENT_TYPE", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.M_STEP_REQUIREMENT", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("M_STEP_REQUIREMENT", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.M_TRAINING_CONTENT_STEP_TRANSITION", b =>
                {
                    ...
                    b.HasIndex("FromStepId", "ActionCode", "ToStepId")
                        .IsUnique()
                        .HasFilter("[TrainingContentFlowId] IS NULL");

                    b.HasIndex("FromStepId", "ActionCode", "TrainingContentFlowId")
                        .HasDatabaseName("IX_Transition_FromStep_Action_Flow");

                    b.HasIndex("FromStepId", "ActionCode", "ToStepId", "TrainingContentFlowId")
                        .IsUnique()
                        .HasFilter("[TrainingContentFlowId] IS NOT NULL");

                    b.ToTable("M_TRAINING_CONTENT_STEP_TRANSITION", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.M_WORKFLOW_ACTION", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("M_WORKFLOW_ACTION", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.M_STEP_REQUIREMENT", b =>
                {
                    b.HasOne("Domain.Entities.M_REQUIREMENT_TYPE", "M_RequirementType")
                        .WithMany("M_StepRequirements")
                    ...
                    b.Navigation("M_RequirementType");
            ...
            modelBuilder.Entity("Domain.Entities.M_TRAINING_CONTENT_STEP_TRANSITION", b =>
                {
                    b.HasOne("Domain.Entities.M_WORKFLOW_ACTION", "M_WorkflowAction")
                        .WithMany("M_TrainingContentStepTransitions")
                        .HasForeignKey("ActionCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.M_TRAINING_CONTENT_STEP", "FromStep")
                    ...
                    b.HasOne("Domain.Entities.M_TRAINING_CONTENT_STEP", "ToStep")
            ...
            modelBuilder.Entity("Domain.Entities.M_REQUIREMENT_TYPE", b =>
                {
                    b.Navigation("M_StepRequirements");
                });
            ...
            modelBuilder.Entity("Domain.Entities.M_STATUS", b =>
                {
                    b.Navigation("M_TrainingContentStepTransitions");
